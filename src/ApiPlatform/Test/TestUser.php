...
class TestUser implements UserInterface
{
  ...
  /**
   * @ApiSubresource()
   * @ORM\OneToMany(targetEntity=TestScheduledShift::class, mappedBy="onDuty")
   */
  private $shifts;

  /**
   * @ApiSubresource()
   * @ORM\OneToMany(targetEntity=TestShiftComments::class, mappedBy="authoredBy", cascade={"persist", "remove"})
   */
  private $comments;

  /**
   * @ApiSubresource()
   * @ORM\OneToMany(targetEntity=TestShiftComments::class, mappedBy="recipient")
   */
  ...
  /**
   * @Query
   * @return Collection|TestScheduledShift[]
   */
   ...
   * @Mutation
   */
  public function addShift(TestScheduledShift $shift): self
  {
   ...
   * @Mutation
   */
  public function removeShift(TestScheduledShift $shift): self
  {
    if ($this->shifts->contains($shift)) {
  ...
  public function addReceivedComment(TestShiftComments $receivedComment): self
  {
  ...
  public function removeReceivedComment(TestShiftComments $receivedComment): self
  {
    if ($this->receivedComments->contains($receivedComment)) {
